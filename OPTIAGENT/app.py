...
def verifier_fraude_factures(state:FactureProcessingState, seuil_montant=1000) -> FactureProcessingState:
    ...
    for facture in factures_data:
        ...
        1. La date est-elle dans l'intervalle de la mission (avec une tolérance d'un jour avant/après) ?
        2. La ville est-elle cohérente avec la destination (ou une ville proche) ?
        3. Le montant est-il raisonnable pour le type de commerce ?
